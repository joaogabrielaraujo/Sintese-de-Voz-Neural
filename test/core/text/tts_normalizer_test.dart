...
void main() {
  group('TTSNormalizer - Testes de Integração End-to-End do Pipeline PLN', () {
    ...
    test('Deve remover acentos e diacríticos de palavras em Português para compatibilidade VITS ONNX', () {
      const String input = 'Capítulo 1: Fundamentação, Objetivos e Versão';
      final String result = TTSNormalizer.removeDiacritics(input);
