...
import 'package:tcc_tts_neural/core/epub/epub_model.dart';
...
void main() {
  group('PipelineOrchestrator - Testes de Integração End-to-End do MVP', () {
    ...
    test('Deve orquestrar o Capítulo 1 do EPUB completo e gerar relatório com RTF < 1.0', () async {
      const chapter = EpubChapter(
        index: 0,
        id: 'c1.xhtml',
        title: 'Capítulo 1: Introdução ao TCC',
        rawHtml: r'<p>Em 24/07/2026, o Dr. Matheus aprovou a 1ª versão do TCC na UEFS custando R$ 150,00.</p>',
        cleanText: r'Em 24/07/2026, o Dr. Matheus aprovou a 1ª versão do TCC na UEFS custando R$ 150,00.',
      );
      ...
      expect(result.items.first.normalizedText, contains('vinte e quatro de julho'));
