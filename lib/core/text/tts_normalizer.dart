...
class TTSNormalizer {
  ...
  /// Remove acentos e caracteres diacríticos para compatibilidade com o modelo VITS ONNX.
  static String removeDiacritics(String input) {
    const String withDiacritics = 'áàâãäéèêëíìîïóòôõöúùûüçÁÀÂÃÄÉÈÊËÍÌÎÏÓÒÔÕÖÚÙÛÜÇ';
    const String withoutDiacritics = 'aaaaaeeeeiiiiooooouuuucAAAAAEEEEIIIIOOOOOUUUUC';
